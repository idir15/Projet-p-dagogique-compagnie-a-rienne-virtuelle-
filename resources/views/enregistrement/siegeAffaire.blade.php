...
<div class="seats_container">
   ...
   @foreach ($ToutNumSiege as $key)
         ...
         @endif
             <div class="airplane_seats__row airplane_seats__row--affaire"> 
		  ...
		  @endif
           ...
           @if(in_array($key, $siegeOccupe))
             @if($colone == 'A'||$colone == 'B' || $colone == 'E'||$colone == 'F')
                <div class="airplane_seats__seat airplane_seats__seat_affaire seat--busy airplane_seats__seat_top" id="{{$key}}">{{$colone}}</div>
             @else
             <div class="airplane_seats__seat airplane_seats__seat_affaire seat--busy airplane_seats__seat_bottom" id="{{$key}}">{{$colone}}</div>
		   ...
		   @else
				...
				@if(in_array($key, $affectation))
                  @if($colone == 'A'||$colone == 'B' || $colone == 'E'||$colone == 'F')
				   <div class="airplane_seats__seat airplane_seats__seat_affaire seat--selected airplane_seats__seat_top" id="{{$key}}">{{array_search($key, $affectation)}}</div>
                  @else
                  <div class="airplane_seats__seat airplane_seats__seat_affaire seat--selected airplane_seats__seat_bottom" id="{{$key}}">{{array_search($key, $affectation)}}</div>

                  @endif
                @else
                    @if($colone == 'A'||$colone == 'B' || $colone == 'E'||$colone == 'F')
                      <div class="airplane_seats__seat airplane_seats__seat_affaire airplane_seats__seat_top" id="{{$key}}">{{$colone}}</div>
                    @else
                     <div class="airplane_seats__seat airplane_seats__seat_affaire airplane_seats__seat_bottom" id="{{$key}}">{{$colone}}</div>
                    @endif
